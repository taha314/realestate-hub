...
const PendingApproval = () => {
  ...
  return (
    <div className={s.container}>
      ...
      <h1 className={s.heading}>Pending Approval</h1>
      <p className={s.description}>
        Hello {user?.name}, your seller account is currently under review by our administration team. Approval usually takes 24 hours. You'll gain full dashboard access once verified.
      </p>
