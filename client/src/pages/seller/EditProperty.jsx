...
const EditProperty = () => {
    ...
    // to submit the updated listings
                        ...
                        <div className={s.sectionContent}>
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Luxury Villa in the Heart of the City"
                                    className={s.input}
                                    required
                                />
                            </div>
                            <div>
                                ...
                                <textarea name="description" value={formData.description}
                                    onChange={handleInputChange} placeholder='Desceibe the property highlights...'
                                    className={s.textarea} required></textarea>
                            </div>
                        </div>
                    </div>
