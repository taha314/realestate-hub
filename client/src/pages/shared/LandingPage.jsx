...
const LandingPage = () => {
  ...
  const fetchWishlist = async () => {
    try {
      ...
      setWishlistedIds((response.data.wishlist || []).filter((item) => item.property).map((item) => String(item.property._id)));
    }
    catch (err) {
    ...
    <div className={s.bgMain}>
      ...
      <section className={s.heroSection}>
        <div className={s.heroContent}>
          <span className={s.badge}>Trusted by 1000+ customers</span>
          <h1 className={s.heroTitle}>Find Your <span className={s.textGradient}>Perfect </span>Next Chapter.</h1>
          <p className={s.heroSubtitle}>Experience most advanced real estate search platform. Discover verified listings, connect with the top agents, and make your dream home a reality.</p>
            ...
            <div className={s.verifiedBadge}>
              ...
              <div>
                ...
                <p className={s.badgeText}>
                  Inspected by real estate experts.
                </p>
              </div>
        ...
        <div className={s.container}>
          <div className={s.categoryHeader}>
            <div className={s.categoryHeaderText}>
              <h2 className={s.categoryTitle}>Brows by Category</h2>
              <p className={s.categoryDesc}>Explore curated collectons of properties tailored to your specific lifestyle and needs.</p>
            </div>
          </div>
        ...
        <div className={s.featuresContainer}>
          ...
          <div className={s.featuresContent}>
            <h2 className={s.featuresHeading}>Why RealEstate <br />
              is the <span className={s.textGradient}>Preferred Choice</span></h2>
        ...
        <div className={s.container}>
          <div className={s.processHeader}>
            ...
            <p className={s.processSubtitle}>
              We've simplified the journy of finding your dream home into three clear, stress-free steps.
            </p>
          </div>
        ...
        <div className={s.container}>
          <div className={s.featuredHeader}>
            ...
            <p className={s.featuredSubtitle}>
              Discover high-value properties curated by our experts or thier exceptional design, location, and investment potential.
            </p>
          </div>
        ...
        <div className={s.container}>
          <div className={s.footerMainGrid}>
            <div className={s.footerBrand}>
              ...
              <p className={s.brandDesc}>
                ...
                real estate globally. We make property hunting seamless.</p>
            ...
            <div>
              ...
              <ul className={s.footerLinks}>
                ...
                <li className={s.contactInfo}>
                  <HiPhone className="text-primary text-xl" /> +92 1234567890
                </li>
                <li className={s.contactInfoStart}>
                  <HiLocationMarker
                    className={`text-primary ${s.contactIcon}`}
                  />
                  123 Business Hub, Pakistan
                </li>
              </ul>
            </div>
            {/* column 4 */}
            <div>
              ...
              <p className={s.newsletterDesc}>
                Subscribe to get the latest listing updates and market insights directly in your inbox.
              </p>
          ...
          <div className={s.bottomBar}>
            <div className={s.bottomBarFlex}>
              <p>&copy; {new Date().getFullYear()} RealEstate. All rights reserved.
              </p>
