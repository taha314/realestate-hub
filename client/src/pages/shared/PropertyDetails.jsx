...
import { HiChevronLeft, HiChevronRight, HiCollection, HiHeart, HiLocationMarker, HiOutlineHeart, HiOutlineHome, HiOutlineUserGroup, HiX, HiOutlineViewGrid, HiCalendar, HiBadgeCheck, HiChatAlt } from 'react-icons/hi';
...
const PropertyDetails = () => {
        ...
        const fetchDetails = async () => {
            try {
                ...
                if (user && user.role === "buyer") {
                    ...
                    const found = (wishRes.data.wishlist || []).some(
    ...
    // to start a chat with the property owner
    ...
    const prevImage = () =>
        ...
        ); //open an image in a box and go to next or previous image in the box
        ...
        <div className={s.pageContainer}>
            ...
            <main className={s.mainContainer}>
                ...
                <div className={s.galleryContainer}>
                    <div className={s.galleryGrid} style={{
                        gridTemplateColumns:
                        ...
                        <div className={s.infoHeader}>
                            <div className={s.titleWrapper}>
                                ...
                                <p className={s.propertyLocation}>
                                    ...
                                    <span className={s.locationText}>{property.area}, {property.city}, Pakistan</span>
                                </p>
                            </div>
                            ...
                            {property.status?.toLowerCase() === "rent" && (
                                <div className={s.rentDetails}>
                                    <div className={s.rentDetailRow}>
                                        ...
                                        <span className={s.rentDetailValue}>PKR{Number(property.securityDeposit || 0).toLocaleString("en-PK")}</span>
                                    </div>
                                    <div className={s.rentDetailRow}>
                                        <span className={s.rentDetailLabel}>Maintenance</span>
                                        <span className={s.rentDetailValue}>PKR{Number(property.maintenance || 0).toLocaleString("en-PK")} / month</span>
                                    </div>
                                </div>
                            )}
